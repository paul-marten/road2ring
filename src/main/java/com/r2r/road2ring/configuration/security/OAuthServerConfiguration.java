...
public class OAuthServerConfiguration {
  ...
  protected static class ResourceServerConfiguration extends
    ...
    public void configure(HttpSecurity http) throws Exception {
      ...
      http
          ...
          .antMatchers("/m/api/consumer/dummy").hasAnyRole("CONSUMER")
          .antMatchers("/m/api/consumer/profile").hasAnyRole("CONSUMER")
          .antMatchers("/m/api/consumer/upload").hasAnyRole("CONSUMER")
          .antMatchers("/m/api/consumer/check").hasAnyRole("CONSUMER")
          .antMatchers("/m/api/just-for-you").hasAnyRole("CONSUMER")
          .antMatchers("/m/api/just-for-you/single").hasAnyRole("CONSUMER")
  ...
  protected static class AuthorizationServerConfiguration extends
    ...
    @Autowired
    @Qualifier("talkUserDetailsService")
